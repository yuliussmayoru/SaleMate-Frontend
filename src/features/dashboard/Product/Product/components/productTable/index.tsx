...
export default function ProductTable({ product = [], handleModalOpen }: ProductTableProps) {
                ...
                <tbody className=" text-gray-1">
                    {Array.isArray(product) && product.length > 0 ? (
                        ...
                        <tr key={product.product_id} className="even:bg-gray-6">
                            <td className="">{product.product_id}</td>
                            <td className="">{product.product_category.category_name}</td>
                        ...
                        <tr>
                            <td colSpan={6} className="py-4">No product available</td>
                        </tr>
                    )}
                </tbody>
            </table>
