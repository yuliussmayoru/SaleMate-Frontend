            ...
            <div className="pt-28">
                <div className="p-6">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <button className="bg-[#eb9c63] text-white font-bold py-2 px-4 rounded">+ Add Product</button>
                    </div>
                                ...
                                <tbody>
                                    {Array.from({ length: 9 }, (_, index) => (
                                        <tr key={index} className="odd:bg-white even:bg-gray-50">
                                            ...
                                            <td className="border px-4 py-2">Activewears</td>
                                            <td className="border px-4 py-2">Black Hoodie</td>
                                            <td className="border px-4 py-2">Rp. 700.000</td>
                                            <td className="border px-4 py-2">2</td>
                                            <td className="border px-4 py-2">All Size</td>
