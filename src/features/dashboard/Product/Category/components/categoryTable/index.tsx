...
import { ProductCategoryTableProps } from './types';

export default function ProductCategoryTable({ productCategories = [], handleModalOpen }: ProductCategoryTableProps) {
                ...
                <tbody className=" text-gray-1">
                    {Array.isArray(productCategories) && productCategories.length > 0 ? (
                        ...
                        <tr key={productCategory.product_category_id} className="even:bg-gray-6">
                            <td className="">{productCategory.product_category_id}</td>
                        ...
                        <tr>
                            <td colSpan={6} className="py-4">No category available</td>
                        </tr>
                    )}
                </tbody>
            </table>
