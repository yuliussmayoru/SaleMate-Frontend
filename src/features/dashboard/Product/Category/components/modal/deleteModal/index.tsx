...
export default function DeleteModal({isDeleteModalOpen, handleModalClose, selectedProductCategory, handleConfirmDelete}: deleteModalProps) {
    return (
        <div>
            <Modal isOpen={isDeleteModalOpen} onClose={handleModalClose} onConfirm={handleModalClose}>
                ...
                <h2 className="p-6 text-2xl text-bold text-gray-1">{selectedProductCategory?.category_name}</h2>
